 ...
 * 
 */
public class GeolocationGeometryViewportNortheast
    implements Serializable
{
    ...
    @OneToOne
    private Float lng;
    private final static long serialVersionUID = 5634992300959504111L;

    public GeolocationGeometryViewportNortheast() {
    }
